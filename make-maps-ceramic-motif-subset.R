...
run1Subtitle = "Ceramic Subset - Similarity = 1.0"
run1FileSuffix = "-ceramic-motif-eq-1"
run1Size = 3.0
...
run3Subtitle = "Ceramic Subset - Similarity >= 0.8"
run3FileSuffix = "-ceramic-motif-gt0-8"
run3Size = 3.0
...
run5Subtitle = "Ceramic Subset - Similarity >= 0.65"
run5FileSuffix = "-ceramic-motif-gt0-65"
run5Size = 3.0
