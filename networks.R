...
#------------------------------------------------------
#------------------------------------------------------
fileSuffix = "-all-65-no-isolates"
thisSubtitle = "All - Threshold 0.65 - Isolates removed"
...
#------------------------------------------------------
fileSuffix = "-all-65"
thisSubtitle = "All - Threshold 0.65"
...
g0_65all <-as_tbl_graph(simnet_65) %>%
  ggraph( layout = 'fr') +
  labs(title="Network ", subtitle=thisSubtitle) +
  geom_edge_link() + 
  geom_node_point(color="orange") +
...
#------------------------------------------------------
fileSuffix = "-all-30"
thisSubtitle = "All - Threshold 0.30"
